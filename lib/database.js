 ...
 *   kv_store  — une entrée par clé métier (_id = "p5_v", value = tableau véhicules…)
 *   users     — comptes synchronisés depuis p5_ac
 *   media.*   — GridFS pour images > ~40 Ko (évite documents JSON énormes)
 *   meta      — infos de migration depuis l’ancien modèle app_state
 *
 * Voir GUIDE_CODE.md pour le lien avec server.js et le client HTML.
 */

const { MongoClient, GridFSBucket, ObjectId } = require('mongodb');

/** Préfixe URL renvoyé au client à la place du base64 lourd */
const MEDIA_PREFIX = '/api/media/';
/** Au-delà de cette taille, une chaîne data:image/… est uploadée en GridFS */
...
/** Construit mongodb+srv://… depuis MONGODB_USER, PASSWORD, HOST (mot de passe brut OK). */
...
/** Parcourt récursivement un objet JSON et remplace les gros base64 par des liens /api/media/… */
