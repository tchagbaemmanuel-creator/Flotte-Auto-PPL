/**
 * Envoi d’e-mails — abstraction unique pour tout le serveur.
 *
 * Priorité :
 *   1. Brevo API (HTTPS) si BREVO_API_KEY — obligatoire sur Render (SMTP bloqué)
 *   2. SMTP nodemailer en local (Gmail, etc.)
 *
 * API publique : init(), isConfigured(), sendMail({ to, subject, text, html })
 */
